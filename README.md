...
<img src="./images/api.png" width=500px alt="API" />
...
<img src="./images/test.png" width=500px alt="Tests" />

### 3. SPA
At todo-react-app folder, execute the command yarn start. Web browser will open at url http://localhost:3000/

<img src="./images/spa.png" width=500px alt="React SPA" />

***

## What technical and functional assumptions did you make when implementing your solution?
I use the latest stable version of .net core 3.0 and Linux OS as developing platform. For the persistence layer I use InMemoryDatabase; it's not a relational database but it let us write Linq sentences and to take advantage of repository pattern (it's based in Entity Framework)
The API endpoints are documented with openAPI (aka swagger). You can see /// comments at the top of each controller method to show them in the api documentation (description, status code, etc)
